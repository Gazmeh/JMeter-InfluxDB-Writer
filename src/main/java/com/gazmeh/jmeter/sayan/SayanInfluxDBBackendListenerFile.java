 ...
 *
 */
public class SayanInfluxDBBackendListenerFile extends InfluxDBBackendListenerFile {
    /**
     * Logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(SayanInfluxDBBackendListenerFile.class);
    
    public SayanInfluxDBBackendListenerFile() {
